...
#Answer: It created a sequence from 1 to 3 by 0.2. It adds 0.2 until it reaches to 3.
...
#Answer: The value of the 3rd element is 22.

#b. Access 2nd and 4th element, what are the values?
ages[2]
ages[4]

#Answer: The values of the 2nd and 4th element are 28 and 36.
